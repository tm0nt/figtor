<template>
  ...
  const items = [
    ...
    { title: 'Histórico', value: 'historico', icon: 'fluent:history-20-regular', to: '/dashboard/historico/'},
    { title: 'Pagamentos', value: 'pagamentos', icon: 'fluent:wallet-20-regular', to: '/dashboard/pagamentos/' },
    { title: 'Aparelhos conectados', value: 'aparelhos', icon: 'fluent:link-square-20-regular', to: '/dashboard/aparelhos/' },
  ];
